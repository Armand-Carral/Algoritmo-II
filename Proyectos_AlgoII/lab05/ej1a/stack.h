...
*/
stack stack_push(stack s, stack_elem e);                   /* FUNCIONA */
...
*/
stack stack_pop(stack s);                                  /* FUNCIONA */
...
*/
unsigned int stack_size(stack s);                          /* FUNCIONA */
...
* @note Only applies to non-empty stacks
*/
stack_elem stack_top(stack s);                              /* FUNCIONA */
...
*/
bool stack_is_empty(stack s);                              /* FUNCIONA */
...
*/
stack_elem *stack_to_array(stack s);                        /* FUNCIONA */
...
*/
stack stack_destroy(stack s);                                /* NO LO HE UTILIZADO */
