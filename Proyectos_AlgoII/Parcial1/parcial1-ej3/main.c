...
int main(int argc, char *argv[]) {
    ...
    unsigned int length = process_file(filepath, playlist);
    ...
    // -- Completar --
    bool sort = array_is_sorted(playlist, length);
    assert(array_is_sorted(playlist, length));
    if(sort == true) {
        printf("is sorted\n");
    }
    else {
    ...
    // -- Completar --
    bool odd_sorted = array_is_odd_sorted(playlist, length);
    assert(array_is_odd_sorted(playlist, length));
    if(odd_sorted == true) {
        printf("is sorted\n");
    }
    else {
